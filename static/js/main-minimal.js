...
$(window).load(function() {
    ...
    MESSAGES.push({
        delay: 800,
        text: 'Одговор није увек на површини'
    });
    MESSAGES.push({
        delay: 1800,
        text: 'Заримдаа та дотогшоо харах хэрэгтэй болно'
    });
    MESSAGES.push({
        delay: 3200,
        text: 'А понекад погледајте тамо где нема ничега'
    });
    MESSAGES.push({
        delay: 4800,
        text: '0JvQvtCy0YPRiNC60LAg0LTQu9GPINC00LXQutC+0LTQtdGA0LA='
    });
    $container = $('#container');
    $message = $('#message');
    $animate = $('#animate');
